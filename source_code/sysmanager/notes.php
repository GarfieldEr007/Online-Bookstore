        ...
        <table width="637" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF">
          ...
          <tr> 
            <td height="8" valign="bottom" colspan="4"> <p align="center">
                <center>
                  <font color="#000060" size='+2'>留言管理</font>
                </center>
            </td>
          </tr>
          ...
          <tr> 
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center">NotesID</p></td>
            <td width="420" height="18" bgcolor="#EBEEF3" valign="bottom"><p align="center">主 题</p></td>
            <td width="100" height="18" bgcolor="#EBEEF3" valign="bottom"><p align="center">时 间</p></td>
          ...
          <?php
			include "connect.php";
			$rs = $db->query("SELECT count(*) FROM notes"); 
			$num = $rs->fetchColumn();
			//var_dump($col);
			$rd = $db->query("SELECT * FROM notes"); 
          ...
          <tr> 
            ...
            <td height="18" bgcolor="#EBEEF3" valign="bottom"> <a href="notes/displaynotes.php?is=<?php print_r($idd_arr[$i]['0']); ?>"><p align="center">&nbsp;<?php print_r($idd_arr[$i]['1']); ?></p></td>
            <td height="18" bgcolor="#EBEEF3" valign="bottom"><p align="center"><?php print_r($idd_arr[$i]['3']); ?></p></td>
            <td height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><a href="notes/deletenotes.php?id=<?php print_r($idd_arr[$i]['0']); ?>"><font color="#000046">删除</font></a></td>
          </tr>
          <?php
			}
		  ?>
