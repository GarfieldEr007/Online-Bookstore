  ...
  <tr> 
    ...
    <td valign="top" height="424" width="575"> <center> <div align="right"> 
        <table width="637" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF">
          <tr> 
            <td height="1" colspan="10" valign="bottom"><font color="#000000">&nbsp;</font></td>
          <tr> 
            <td height="2" valign="bottom" colspan="10"><p align="center">
                <center>
                  <a href="book/addbook.php"><font color="#000060" size='+2'>添加书目</font></a> 
                </center></p>
            </td>
          </tr>
          
          <tr>
            <td height="1" colspan="10" valign="bottom"> </tr></form>
          <tr> 
            <td height="3" valign="top" colspan="7" bgcolor="#000000"> </td>
          </tr> 
          
          <tr> 
            <td width="42" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center">BookID</p></td>
            <td width="150" height="18" bgcolor="#EBEEF3" valign="bottom"><p align="center">&nbsp;书名</p></td>
            <td width="200" height="18" bgcolor="#EBEEF3" valign="bottom"><p align="center">作者</p></td>
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"><p align="center">价格</p></td>
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"><p align="center">销量</p></td>
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"><p align="center">分类</p></td>
            <td height="18" bgcolor="#EBEEF3" valign="bottom" width="72"><p align="center">-删除-</p></td>
          </tr>
           <tr> 
            <td height="3" valign="top" colspan="7" bgcolor="#000000"> </td>
          </tr>
          ...
          <tr> 
            ...
            <td height="18" bgcolor="#EBEEF3" valign="bottom"><a href="book/displaybook.php?is=<?php print_r($idd_arr[$i]['0']); ?>"><p align="center">&nbsp;<?php print_r($idd_arr[$i]['1']); ?></p></td>
            ...
            <td height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><?php print_r($idd_arr[$i]['6']); ?></a></td>
            <td height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><?php print_r($idd_arr[$i]['8']); ?></a></td>
            <td height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><a href="book/deletebook.php?id=<?php print_r($idd_arr[$i]['0']); ?>"><font color="#000046">删除</font></a></td>
          </tr>
          <?php
			}
		  ?>
