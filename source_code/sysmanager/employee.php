  ...
  <tr> 
    ...
    <td valign="top" height="424" width="575"> <center> <div align="right"> 
        <table width="637" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF">
          <tr> 
           ...
           <tr> 
            <td height="8" valign="bottom" colspan="4"> <p align="center">
                <center>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#000060" size='+2'>员工管理</font>
                </center>
            </td>
          </tr>
          ...
          <tr> 
            <td width="42" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center">EmployeeID</p></td>
          ...
          <?php
			include "connect.php";
			$rs = $db->query("SELECT count(*) FROM ordermanager"); 
			$num = $rs->fetchColumn();
			//var_dump($col);
			$rd = $db->query("SELECT * FROM ordermanager"); 
          ...
          <tr> 
            ...
            <td height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><a href="employee/deleteemployee.php?id=<?php print_r($idd_arr[$i]['0']); ?>"><font color="#000046">删除</font></a></td>
          </tr>
          <?php
			}
		  ?>
