        ...
        <table width="637" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF">
          ...
          <tr> 
            <td height="8" valign="bottom" colspan="4"> <p align="center">
                <center>
                  <font color="#000060" size='+2'>书目详情</font>
                </center>
            </td>
          </tr>
		  ...
		  include "connect.php";
		  $u=$_GET["is"];
		  //$rs = $db->query("SELECT l_tiltle FROM notes where (l_id='$u')"); 
		  //$rd = $db->query("SELECT l_content FROM notes where (l_id='$u')");
		  //$num = $rs->fetchColumn();
		  $rd = $db->query("SELECT * FROM bookitem where (b_id='$u')"); 
		  $idd_arr = $rd->fetch();
		  ?>
          <tr> 
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center">书 名</p></td>
            <td width="600" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><?php print_r($idd_arr['1']); ?></p></td>
          </tr>
          <tr> 
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center">作 者</p></td>
            <td width="600" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><?php print_r($idd_arr['2']); ?></p></td>
          </tr>
          <tr> 
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center">价 格</p></td>
            <td width="600" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><?php print_r($idd_arr['3']); ?></p></td>
          </tr>
          <tr> 
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center">出版社</p></td>
            <td width="600" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><?php print_r($idd_arr['4']); ?></p></td>
          </tr>
          <tr> 
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center">图 片</p></td>
            <td width="600" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><?php print_r($idd_arr['5']); ?></p></td>
          </tr>
          <tr> 
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center">销 量</p></td>
            <td width="600" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><?php print_r($idd_arr['6']); ?></p></td>
          </tr><tr> 
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center">分 类</p></td>
            <td width="600" height="18" bgcolor="#EBEEF3" valign="bottom"> <p align="center"><?php print_r($idd_arr['8']); ?></p></td>
          </tr>
           <tr> 
            <td height="3" valign="top" colspan="2" bgcolor="#000000"> </td>
          </tr>
          <tr> 
            <td width="60" height="18" bgcolor="#EBEEF3" valign="bottom"><p align="center">简 介</p></td>
            <td width="600" height="18" bgcolor="#EBEEF3" valign="bottom"> <?php print_r($idd_arr['7']); ?></td>
          </tr>
           <tr> 
            <td height="3" valign="top" colspan="2" bgcolor="#000000"> </td>
          </tr>
