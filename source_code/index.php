...
onload="MM_preloadImages('image/c02.gif','image/shoucang02.gif','image/kefu02.gif','image/shouyin02.gif')">
<DIV align=center>
<CENTER>
    ...
    <TD background=image/ditu.gif>
      <TABLE cellSpacing=0 cellPadding=0 width=744 border=0>
        ...
        <TR>
          ...
          <TD width=76><a href="user/userlogin.php"><IMG height=36 
...
name=Image40></A></TD>
          ...
          name=Image38></A></TD>
          <TD width=84><a href="company/kefu.php"><IMG height=36 
...
<TABLE cellSpacing=0 cellPadding=0 width=741 border=0>
  ...
  <TR>
                ...
                height=23>
                  <TABLE height=22 width="88%" border=0>
                    ...
                    <TR>
                      <TD width="17%">&nbsp;</TD>
                      <TD width="83%"><FONT 
                        color=#ffffff><STRONG>成为会员</STRONG></FONT></TD></TR></TBODY></TABLE></TD></TR>
              <TR>
                <TD height=4></TD></TR></TBODY></TABLE>
            <TABLE cellSpacing=1 cellPadding=0 width=164 bgColor=#c6c6c6 
            border=0>
                    ...
                    <TR>
                      <TD style="LINE-HEIGHT: 20px"><FONT 
                        color=#ff9900>·</FONT><FONT color=#0000ff size=2><a
                              href="user/userlogin.php">登录</A></FONT>
                         </TD>
                      <TD style="LINE-HEIGHT: 20px"><FONT 
                        color=#ff9900>·</FONT><FONT color=#0000ff size=2><a
                              href="user/userregister.php">注册</A></FONT>
                         </TD>
                         </TR></TBODY></TABLE>
                         <br>
    ...
    <TD vAlign=top align=left width=550 height=598>
      ...
      background="" border=0>
        ...
        <TR>
          <TD vAlign=top height=13>
            ...
            border=0>
              <TBODY>
              <TR>
                <TD vAlign=bottom width="39%"><a href="more.php"><IMG height=48 border=0 
                  src="image/kind061.gif" width=232></TD>
                  ...
                  <TABLE width="55%" border=0>
                    ...
                    <TR>
                      <TD vAlign=top width="16%" rowSpan=4><A href="web/detail.php?bid1=<?php print_r($idd_arr[$i]['0']); ?>"><IMG style="CURSOR: hand" height=90 alt=详细资料 
                        src="picture/<?php print_r($idd_arr[$i]['5']); ?>" width=70></A></TD>
                    ...
                    <TR>
                      <TD width="84%">
                        ...
                        color=#0000ff><a href="user/userlogin.php"><IMG src="image/cart.gif" 
                        border=0>购买</A></FONT> <FONT color=#0000ff><A 
                        style="CURSOR: hand" 
                        onclick="window.open('favorite.asp?P=站内测试标题&amp;Price=22&amp;T=picture.jpg',null,'width=560,height=360,scrollbars=1')" 
                        href=""><IMG src="image/favor.gif" 
                  ...
                  <TABLE width="55%" border=0>
                    ...
                    <TR>
                      <TD vAlign=top width="16%" rowSpan=4><A 
                        ...
                        src="picture/<?php $s=$i-1;print_r($idd_arr[$s]['5']); ?>" width=70></A></TD>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD vAlign=bottom width="39%"><IMG height=48 
                  src="image/kind07.gif" width=232></TD>
                <TD vAlign=bottom align=left width="61%"><IMG height=15 
                  src="image/kind06-1.gif" 
          width=341></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
        ...
        <TR>
          <TD vAlign=top height=139>
            <TABLE height=74 cellSpacing=0 cellPadding=0 width="100%" 
              border=0><TBODY>
              <TR>
                    ...
                    <TR>
                      <TD>
                        <TABLE width="55%" border=0>
                          ...
                          <TR>
                            <TD vAlign=top width="16%" rowSpan=4><A 
                              onclick="window.open('introduce.asp?P=站内测试标题&amp;T=picture.jpg',null,'width=520,height=400,scrollbars=1')" 
                              href=""><IMG style="CURSOR: hand" height=90 
                              alt=详细资料 src="image/picture.jpg" 
                              width=70></A><A 
                              onclick="window.open('introduce.asp?P=站内测试标题&amp;T=C22.jpg ',null,'width=520,height=400,scrollbars=1')" 
                              href=""></A></TD>
                            <TD width="84%"><FONT color=#660000 
                              size=2><B><FONT color=#000066>商品名:</FONT><FONT 
                              color=#990000 size=2><B><FONT 
                              color=#000066>站内测试标题</FONT></B></FONT><FONT 
                              color=#000066>(</FONT><FONT color=#990000 
                              size=2><B><FONT 
                              color=#000066>精装2CD</FONT></B></FONT><FONT 
                              color=#000066>)</FONT></B></FONT></TD></TR>
                          <TR>
                            <TD width="84%"><FONT color=#660000 
                              size=2><U>原始价格:</U></FONT><FONT size=2><U><FONT 
                              color=#660000><STRIKE>38</STRIKE></FONT></U></FONT><FONT 
                              color=#660000 size=2><U>元 会员价格:</U></FONT><FONT 
                              size=2><U><FONT 
                              color=#660000>30</FONT></U></FONT><FONT 
                              color=#660000 size=2><U>元</U></FONT></TD></TR>
                          <TR>
                            <TD width="84%"><BR><FONT 
                              size=2>站内测试信息，站内测试信息。</FONT></TD></TR>
                          <TR>
                            <TD width="84%">
                              ...
                              style="CURSOR: hand" 
                              onclick="window.open('introduce.asp?P=站内测试标题&amp;T=picture.jpg',null,'width=520,height=400,scrollbars=1')" 
                              href=""><FONT color=#0000ff>详细资料</FONT></A> <FONT 
                              color=#0000ff><a href="user/userlogin.php"><IMG src="image/cart.gif" 
                              border=0>购买</A></FONT> <FONT color=#0000ff><A 
                              style="CURSOR: hand" 
                              onclick="window.open('favorite.asp?P=站内测试标题&amp;Price=30&amp;T=picture.jpg',null,'width=560,height=360,scrollbars=1')" 
                              href=""><IMG src="image/favor.gif" 
                              border=0>收藏</A></FONT></FONT></P></TD></TR>
                          <TR>
                            <TD width="16%">
                        ...
                        <TABLE width="55%" border=0>
                          ...
                          <TR>
                            ...
                            <TD width="84%"><FONT color=#660000 
                              ...
                              color=#000066>(</FONT><FONT color=#990000 
                              size=2><B><FONT 
                              color=#000066>精装1CD</FONT></B></FONT><FONT 
                              color=#000066>)</FONT></B></FONT></TD></TR>
                          <TR>
                            <TD width="84%"><FONT color=#660000 
                              size=2><U>原始价格:</U></FONT><FONT size=2><U><FONT 
                              color=#660000><STRIKE>28</STRIKE></FONT></U></FONT><FONT 
                              color=#660000 size=2><U>元 会员价格:</U></FONT><FONT 
                              size=2><U><FONT 
                              color=#660000>22</FONT></U></FONT><FONT 
                              color=#660000 size=2><U>元</U></FONT></TD></TR>
                          <TR>
                            <TD width="84%"><BR><FONT 
                              size=2>站内测试信息，站内测试信息。</FONT></TD></TR>
                        ...
                        <TABLE width="55%" border=0>
                          ...
                          <TR>
                            ...
                            <TD width="84%"><FONT color=#660000 
                              ...
                              color=#000066>(</FONT><FONT color=#990000 
                              size=2><B><FONT 
                              color=#000066>1CD+1本书</FONT></B></FONT><FONT 
                              color=#000066>)</FONT></B></FONT></TD></TR>
                          <TR>
                            <TD width="84%"><FONT color=#660000 
                              size=2><U>原始价格:</U></FONT><FONT size=2><U><FONT 
                              color=#660000><STRIKE>28.00</STRIKE></FONT></U></FONT><FONT 
                              color=#660000 size=2><U>元 会员价格:</U></FONT><FONT 
                              size=2><U><FONT 
                              color=#660000>22.00</FONT></U></FONT><FONT 
                              color=#660000 size=2><U>元</U></FONT></TD></TR>
                          <TR>
                            <TD width="84%"><BR><FONT 
                              size=2>站内测试信息，站内测试信息。</FONT></TD></TR>
                          <TR>
                            <TD width="84%">
                              ...
                              border=0>购买</A></FONT> <FONT color=#0000ff><A 
                              style="CURSOR: hand" 
                              onclick="window.open('favorite.asp?P=站内测试标题&amp;Price=22.00&amp;T=picture.jpg',null,'width=560,height=360,scrollbars=1')" 
                              href=""><IMG src="image/favor.gif" 
                              border=0>收藏</A></FONT></FONT></P></TD></TR>
                          <TR>
                            <TD width="16%">
                        ...
                        <TABLE width="55%" border=0>
                          ...
                          <TR>
                            ...
                            <TD width="84%"><FONT color=#660000 
                              ...
                              color=#000066>(</FONT><FONT color=#990000 
                              size=2><B><FONT 
                              color=#000066>5CD精装</FONT></B></FONT><FONT 
                              color=#000066>)</FONT></B></FONT></TD></TR>
                          <TR>
                            <TD width="84%"><FONT color=#660000 
                              size=2><U>原始价格:</U></FONT><FONT size=2><U><FONT 
                              color=#660000><STRIKE>48.00</STRIKE></FONT></U></FONT><FONT 
                              color=#660000 size=2><U>元 会员价格:</U></FONT><FONT 
                              size=2><U><FONT 
                              color=#660000>40.00</FONT></U></FONT><FONT 
                              color=#660000 size=2><U>元</U></FONT></TD></TR>
                          <TR>
                            <TD width="84%"><BR><FONT 
                              size=2>站内测试信息，站内测试信息。</FONT></TD></TR>
                          <TR>
                            <TD width="84%">
                              ...
                              border=0>购买</A></FONT> <FONT color=#0000ff><A 
                              style="CURSOR: hand" 
                              onclick="window.open('favorite.asp?P=站内测试标题&amp;Price=40.00&amp;T=picture.jpg',null,'width=560,height=360,scrollbars=1')" 
                              href=""><IMG src="image/favor.gif" 
                              border=0>收藏</A></FONT></FONT></P></TD></TR>
                          <TR>
                            <TD width="16%">
        ...
        <TR>
          <TD height=7>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD vAlign=bottom width="39%"><IMG height=48 
                  src="image/kind08.gif" width=232></TD>
                <TD vAlign=bottom align=left width="61%"><IMG height=15 
                  src="image/kind06-1.gif" 
          width=341></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
                ...
                <TD vAlign=top height=74>
                  <TABLE width="100%" border=0>
                    ...
                    <TR>
                      <TD vAlign=top width="16%" rowSpan=4><A 
                        onclick="window.open('introduce.asp?P=站内测试标题&amp;T=picture.jpg',null,'width=520,height=400,scrollbars=1')" 
                        href=""><IMG style="CURSOR: hand" height=90 alt=详细资料 
                        src="image/picture.jpg" width=70 border=0></A></TD>
                      <TD width="82%"><FONT size=2><B><FONT 
                        color=#000066>商品名:站内测试标题 (2CD)</FONT></B></FONT></TD></TR>
                    <TR>
                      <TD width="82%"><FONT color=#660000 
                        size=2><U>原始价格:<STRIKE>38.00</STRIKE>元 
                        会员价格:30.00元</U></FONT></TD></TR>
                    <TR>
                      <TD width="82%"><BR><FONT 
                    size=2>站内测试信息，站内测试信息。</FONT></TD></TR>
                    <TR>
                      <TD width="82%">
                        <P align=right><FONT size=2><A style="CURSOR: hand" 
                        onclick="window.open('introduce.asp?P=站内测试标题&amp;T=picture.jpg',null,'width=520,height=400,scrollbars=1')" 
                        href=""><FONT color=#0000ff>详细资料</FONT></A><FONT 
                        color=#0000ff></FONT><FONT color=#0000ff><a href="user/userlogin.php"><IMG src="image/cart.gif" 
                        border=0>购买</A></FONT> <A style="CURSOR: hand" 
                        onclick="window.open('favorite.asp?P=站内测试标题&amp;Price=30.00&amp;T=picture.jpg',null,'width=560,height=360,scrollbars=1')" 
                        href=""><FONT color=#0000ff><IMG 
                        src="image/favor.gif" 
                        border=0>收藏</FONT></A></FONT></P></TD></TR>
                    <TR>
                      <TD width="16%">
                        <CENTER></CENTER>
                    <TR>
                      <TD colSpan=2 height=9><IMG height=10 
                        src="image/line.gif" 
                  width=573></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
            <TABLE height=74 cellSpacing=0 cellPadding=0 width="100%" 
              border=0><TBODY>
              <TR>
                <TD vAlign=top height=74>
  ...
  href="index.php"><AREA shape=RECT coords=88,1,145,26 
  href="index.php"><AREA shape=RECT coords=225,2,278,25 
  href="company/guanyu.php"><AREA shape=RECT coords=157,2,210,25 
  href="user/userlogin.php">
