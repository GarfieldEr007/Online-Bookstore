...
<TABLE cellSpacing=0 cellPadding=0 width=806 border=0>
              ...
              <TR>
                ...
                <TD>
                  <TABLE width="80%" border=0>
                    <TBODY>
                    <TR>
                      <TD vAlign=top width="16%" rowSpan=4><A href="detail.php?bid1=<?php print_r($u); ?>"><IMG style="CURSOR: hand" height=90 alt=详细资料 
                        src="../picture/<?php 
						//$im=(int)$idd_arr['0'];
						$rb = $db->query("select * from bookitem where b_id='$u'");
						$bn=$rb->fetch();
                      ...
                      <TD width="84%"><FONT color=#990000 size=2><B><FONT 
						...
						$bn=$rb->fetch();
						//var_dump($bn);
						print_r($bn['1']); ?></FONT><font color="#996600">&nbsp;&nbsp;&nbsp;￥:<?php print_r($idd_arr['3']);?> 元</font></B></FONT></TD></TR>

                    <TR>
                      <TD width="84%"><BR><FONT 
                    size=2><br>作者：<?php print_r($idd_arr['2']);?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp 出版社：<?php print_r($idd_arr['4']);?><br>类别：<?php print_r($idd_arr['8']);?>        &nbsp;&nbsp;&nbsp 销量：<?php print_r($idd_arr['6']);?></FONT></TD></TR>
                    <TR>
                      <TD width="16%">
                        <CENTER></CENTER>
                    <TR>
              ...
              <TR>
                ...
                <TD>
                  <TABLE width="100%" border=0>
                    ...
                    <TR>
                      <TD width="84%"><BR><FONT 
                    size=2><center><font size="+2" color="#333333">简介</font></center><br>&nbsp;&nbsp;&nbsp;&nbsp<?php print_r($idd_arr['7']);?></FONT></TD></TR>
                    <TR>
                      <TD width="16%">
                        <CENTER></CENTER>
                    <TR>
  ...
  href="../user/my.php"></MAP></CENTER></BODY></HTML>
