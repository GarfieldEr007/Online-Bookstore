        ...
        <TR>
          <TD vAlign=top height=13>
            ...
            border=0>
              <TBODY>
              <TR>
                <TD vAlign=bottom width="39%"> <a href="usermore.php"><IMG border=0 height=48 
                  src="image/kind061.gif" width=232></a></TD>
                        ...
                        <TABLE width="55%" border=0>
                          ...
                          <TR>
                            <TD width="84%">
                              ...
                              color=#0000ff><A style="CURSOR: hand" 
                              onclick="window.open('shopbag.asp?P=站内测试标题&amp;Price=30',null,'width=560,height=360,scrollbars=1')" 
                              href=""><IMG src="image/cart.gif" 
                              border=0>购买</A></FONT> <FONT color=#0000ff><A 
                              style="CURSOR: hand" 
                        ...
                        <TABLE width="55%" border=0>
                          ...
                          <TR>
                            <TD width="84%">
                              ...
                              href=""><FONT color=#0000ff>详细资料</FONT></A> <FONT 
                              color=#0000ff><A style="CURSOR: hand" 
                              onclick="window.open('shopbag.asp?P=站内测试标题&amp;PP=28&amp;Price=22',null,'width=560,height=360,scrollbars=1,status=0')" 
                              href=""><IMG src="image/cart.gif" 
                              border=0>购买</A></FONT> <FONT color=#0000ff><A 
                              style="CURSOR: hand" 
                        ...
                        <TABLE width="55%" border=0>
                          ...
                          <TR>
                            <TD width="84%">
                              ...
                              href=""><FONT color=#0000ff>详细资料</FONT></A> <FONT 
                              color=#0000ff><A style="CURSOR: hand" 
                              onclick="window.open('shopbag.asp?P=站内测试标题&amp;Price=22.00',null,'width=560,height=360,scrollbars=1')" 
                              href=""><IMG src="image/cart.gif" 
                              border=0>购买</A></FONT> <FONT color=#0000ff><A 
                              style="CURSOR: hand" 
                        ...
                        <TABLE width="55%" border=0>
                          ...
                          <TR>
                            <TD width="84%">
                              ...
                              href=""><FONT color=#0000ff>详细资料</FONT></A> <FONT 
                              color=#0000ff><A style="CURSOR: hand" 
                              onclick="window.open('shopbag.asp?P=站内测试标题&amp;PP=48.00&amp;Price=40.00',null,'width=560,height=360,scrollbars=1,status=0')" 
                              href=""><IMG src="image/cart.gif" 
                              border=0>购买</A></FONT> <FONT color=#0000ff><A 
                              style="CURSOR: hand" 
                  ...
                  <TABLE width="100%" border=0>
                    ...
                    <TR>
                      <TD width="82%">
                        ...
                        onclick="window.open('introduce.asp?P=站内测试标题&amp;T=picture.jpg',null,'width=520,height=400,scrollbars=1')" 
                        href=""><FONT color=#0000ff>详细资料</FONT></A><FONT 
                        color=#0000ff></FONT><FONT color=#0000ff><A 
                        style="CURSOR: hand" 
                        onclick="window.open('shopbag.asp?P=站内测试标题&amp;Price=30.00',null,'width=560,height=360,scrollbars=1')" 
                        href=""><IMG src="image/cart.gif" 
