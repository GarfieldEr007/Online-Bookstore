  ...
  <table border="0" cellpadding="0" cellspacing="0" width="780">
    ...
    <tr>
      <td width="157" height="16" bgcolor="#93BEF2" valign="bottom"> 
        <div align="center"><a href="../userindex.php">首页</a></div>
      </td>
      <center>
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="780" height="45">
	...
	<tr>
      ...
      <FORM name=userregister onsubmit="return checkform();" action=update.php method=post>
  </center>
        <div align="center">
        <table border="1" cellpadding="0" cellspacing="0" width="352" height="1" bordercolor="#000000" bordercolorlight="#000000" bordercolordark="#FFFFFF">
          <tr>
            <td width="350" height="13" background="../images/t-bg1.gif">
              <p align="center"><strong>=== 修改账户 ===</strong></td>            
          </tr>
  <center>
          <center>
          <tr>
            <td width="350" height="263" bgcolor="#fffff4">
              ...
              <p align="center"><input type="submit" value="提 交" name="B1" style="position: relative; height: 19"></td>
          </tr>
          </center>
  </center>
  <center>
