...
if($result||$re)
{
  header("Location:userrepeat.php");
}

else //if($ut=="1")
	{
//mysql_query("INSERT INTO user(username,password) VALUES('$u','$p')");
	$db->exec("INSERT INTO customer SET c_name = '$u',c_password='$p',c_email='$e'");
//mysql_close($conn);
@$_SESSION["user2"]=$u;
