      ...
      background="" border=0 height=613>
            ...
            border=0>
              ...
              <TR>
                <TD vAlign=bottom width="39%"><IMG height=48 
                  src="../image/kind03.jpg" width=232></TD>
        ...
        <TR>
          ...
          <?php
			...
			@session_start();
			$p=$_SESSION["user2"];
			$rd = $db->query("SELECT * FROM customer where c_name='$p'"); 
			$idd_arr = $rd->fetch();
			//var_dump($idd_arr);
 			?>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=1>
              ...
              <TR>
                <TD>
                  <TABLE width="80%" border=0>
                    ...
                    <TR>
                      <TD width="84%"><BR><FONT 
                    size=2>昵称：<?php print_r($idd_arr['1']); ?><br>密码：<font color="#FF0000"><?php print_r($idd_arr['2']);?></font><br>注册邮箱：<?php print_r($idd_arr['3']);?></FONT></TD></TR>
                    <TR>
                      <TD width="16%">
                        <CENTER></CENTER>
                    <TR>
              ...
              <TR>   
                  ...
                  <TABLE width="80%" border=0>
                    ...
                    <TR>
                      <TD width="84%"><BR><FONT 
                    size=2>是否要修改个人账户：<a href="reset.php">是</a>&nbsp;&nbsp;<a href="../userindex.php">否</a></FONT></TD></TR>
                    <TR>
                      <TD width="16%">
                        <CENTER></CENTER>
                    <TR>
