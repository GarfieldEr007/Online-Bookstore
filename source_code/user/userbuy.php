            ...
            border=0>
              ...
              <TR>
                <TD vAlign=bottom width="39%"><IMG height=48 
                  src="../image/kind02.jpg" width=232></TD>
...
<div align="center">
    <center>
    <br><br><br><br>
      <table border="1" cellpadding="0" cellspacing="0" width="450" height="120" bordercolor="#000000" bordercolorlight="#000000" bordercolordark="#FFFFFF">
        <tr>
          <td width="446" height="27" valign="bottom" background="../image/t-bg1.gif">
          <br>
            <p align="center"><font size=4><strong>=== 请填写您的收货地址 ===</strong></font></td>                 
        </tr>
        <tr>
          
        <td valign="top" bgcolor="#fffff4" width="446"> 
          <p align="center"><br><textarea rows="6" name="address" cols=50> </textarea>
          <input type="hidden" name="bid1" value=<?php $u=$_GET["bid"]; print_r($u); ?>>
             <p align="center"> 
            <input name="submit" type="submit" style="position: relative; height: 20;" value="提 交">
            <br>
            <br>
        </td>
        </tr>
